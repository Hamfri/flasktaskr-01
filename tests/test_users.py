...
class AllTests(unittest.TestCase):
    ...
    def test_users_can_register(self):
        ...
        for t in test:
            t.name
        assert t.name == "michael" and t.email == "michael@mherman.org"
    ...
    def test_duplicate_user_registration_trows_error(self):
        self.register("Hamfri", "hamfri@creativehub.com", "python", "python")
        response = self.register("Hamfri", "hamfri@creativehub.com", "python", "python")
